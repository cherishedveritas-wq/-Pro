    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm">향후 5개년 재무 추정 가정을 설정합니다.</p>
        </div>
        <button 
          onClick={applyHistoricalAverages}
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-50 border border-indigo-200 rounded-lg text-sm font-medium text-indigo-700 hover:bg-indigo-100 transition-colors shadow-sm"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Input
          ...
          type="number"
          step="0.1"
          value={projections.revenueGrowthRate}
          onChange={(e) => updateProjection('revenueGrowthRate', Number(e.target.value))}
          suffix="%"
        ...
        <Input
          ...
          type="number"
          step="0.1"
          value={projections.operatingMargin}
          onChange={(e) => updateProjection('operatingMargin', Number(e.target.value))}
          suffix="%"
        ...
        <Input
          ...
          type="number"
          step="0.1"
          value={projections.daPercentOfRevenue}
          onChange={(e) => updateProjection('daPercentOfRevenue', Number(e.target.value))}
          suffix="%"
        ...
        <Input
          ...
          type="number"
          step="0.1"
          value={projections.capexPercentOfRevenue}
          onChange={(e) => updateProjection('capexPercentOfRevenue', Number(e.target.value))}
          suffix="%"
        ...
        <Input
          ...
          type="number"
          step="0.1"
          value={projections.nwcPercentOfRevenue}
          onChange={(e) => updateProjection('nwcPercentOfRevenue', Number(e.target.value))}
          suffix="%"
        ...
        <Input
          ...
          onChange={(e) => updateProjection('taxRate', Number(e.target.value))}
          suffix="%"
        ...
        <Input
          ...
          type="number"
          step="0.1"
          value={projections.terminalGrowthRate}
          onChange={(e) => updateProjection('terminalGrowthRate', Number(e.target.value))}
          suffix="%"
          tooltip="추정 기간(5년) 이후의 영구적인 성장률입니다. 일반적으로 0%에서 3% 사이를 적용합니다."
        />
      </div>

      <div className="bg-slate-50 p-4 md:p-6 rounded-xl border border-slate-200 mt-8">
